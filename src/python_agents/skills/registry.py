...
from src.python_agents.config import SKILLS_SEARCH_PATHS
from src.python_agents.skills.base import BaseSkill
from src.python_agents.skills.loader import SkillDefinition, build_skill_catalog, discover_skills
...
def build_default_registry(search_paths: list[Path] | None = None) -> SkillRegistry:
    ...
    if not definitions:
        logger.warning(
            ...
            "Crea skills en .agents/skills/<nombre>/SKILL.md",
